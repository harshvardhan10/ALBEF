#!/usr/bin/env python3
"""Train original/lung/heart ALBEF with parameter-free simple mean fusion.
...
from models.model_pretrain_multiview_mean_fusion import ALBEF
...
EXPERIMENT_NAME = "A0_multiview_mean_fusion_dual_auc"
