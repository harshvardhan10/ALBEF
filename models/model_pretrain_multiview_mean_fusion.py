"""Multi-view ALBEF with parameter-free token-wise mean fusion.

Aligned original, lung and heart ViT tokens are averaged exactly:
    (original + lung + heart) / 3.
No trainable view-fusion parameters are introduced. The resulting
[B,257,768] sequence is used by ITC, ITM and MLM.
"""
...
class SimpleMeanFusion(nn.Module):
    """Parameter-free arithmetic mean of the three aligned token streams."""
...
class ALBEF(nn.Module):
    def __init__(
        ...
        self.view_fusion = SimpleMeanFusion()
        ...
        self.view_fusion_m = SimpleMeanFusion()
